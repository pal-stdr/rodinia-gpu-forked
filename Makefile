...
CUDA_DIRS := backprop bfs cfd gaussian heartwall hotspot hotspot3D kmeans lavaMD leukocyte lud nn	nw srad srad_v1 streamcluster particlefilter pathfinder mummergpu
